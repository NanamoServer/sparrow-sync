...
import net.momirealms.sparrow.sync.util.Pair;
...
public abstract class BukkitCommandFeature extends AbstractCommandFeature {
    ...
    public BukkitCommandFeature(CommandManager commandManager, SparrowSync plugin) {
    ...
    @Override
    public SparrowSync plugin() {
        return (SparrowSync) super.plugin();
    }
}
