...
final class MysqlSchemaMigrator {
    ...
    private void migrateLocked(Handle handle, String prefix) {
        ...
        if (stored == 0) {
            ...
            this.logger.info(LogCategory.STORAGE, LogConstants.STORAGE_MYSQL_SCHEMA_INITIALIZING, prefix, String.valueOf(this.currentVersion));
        ...
        for (int i = (int) stored - 1; i < this.migrations.size(); i++) {
            ...
            this.logger.info(LogCategory.STORAGE, LogConstants.STORAGE_MYSQL_SCHEMA_MIGRATING, prefix, String.valueOf(target - 1), String.valueOf(target));
